...
export const PatternReviewInputSchema = z.object({
	pr: PrContextSchema,
	diff: z.object({ files: z.array(DiffFileSchema) }),
	context_files: z.array(ContextFileSchema),
});

export type PatternReviewInput = z.infer<typeof PatternReviewInputSchema>;

export const DiffAnalysisSchema = z.object({
	summary: z.string(),
	touched_concerns: z.array(z.string()),
...
export const FindingSchema = z.object({
	file_path: z.string(),
	file_line: z.number().int().positive(),
