...
function buildLocalAgentConfig(env: NodeJS.ProcessEnv = process.env): LocalAgentConfig {
...
if (import.meta.main) {
  ...
  const outputPath = resolve(
    process.env.WIDE_EVENTS_AGENT_CONFIG_PATH ?? ".wide-events-agent/config.json",
  );
