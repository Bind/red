...
WIDE_EVENTS_LAB_REPLAY_WINDOW_MS="${WIDE_EVENTS_LAB_REPLAY_WINDOW_MS:-600000}"
...
WIDE_EVENTS_LAB_SWEEP_INTERVAL_MS=$WIDE_EVENTS_LAB_SWEEP_INTERVAL_MS
WIDE_EVENTS_LAB_INCOMPLETE_GRACE_MS=$WIDE_EVENTS_LAB_INCOMPLETE_GRACE_MS
WIDE_EVENTS_LAB_REPLAY_WINDOW_MS=$WIDE_EVENTS_LAB_REPLAY_WINDOW_MS
...
docker compose -f "$COMPOSE_FILE" up -d minio minio-init wide-events git-server auth-db auth api bff web
