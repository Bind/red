...
TRIAGE_MAX_WALLCLOCK_MS="${TRIAGE_MAX_WALLCLOCK_MS:-600000}"
...
TRIAGE_MAX_WALLCLOCK_MS=$TRIAGE_MAX_WALLCLOCK_MS
...
docker compose --env-file .env -f "$COMPOSE_FILE" up -d s3 init obs grs db-auth auth ctl bff web gateway
